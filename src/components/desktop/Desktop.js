		...
		<div className="desktop">
			<div className="div">
				<img
					className="rectangle"
					alt="Rectangle"
					src="https://c.animaapp.com/sHJwGhwy/img/rectangle-1.svg"
				/>
				...
				<p className="welcome-back-bella">
					...
					<span className="span">
						! Your progress is about to be amazing! Keep at it
					</span>
				</p>
				...
				<div className="group-2">
					<img
						className="vector"
						alt="Vector"
						src="https://c.animaapp.com/sHJwGhwy/img/vector-4.svg"
					/>
				...
				<div className="text-wrapper-29">Budgeting with Pokémon</div>
				<p className="text-wrapper-30">
					Saving and Investing in the Anime World
				</p>
				<p className="text-wrapper-31">Debt Management with Anime Characters</p>
				<p className="text-wrapper-32">
					Building Credit Using Pokémon Principles
				</p>
				<div className="rectangle-6">
					<img
						...
						height={'100%'}
						width={'100%'}
						src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fi.pinimg.com%2Foriginals%2F87%2Fdd%2F0d%2F87dd0d33d064abeebacb11dd87029b48.jpg&f=1&nofb=1&ipt=2e2845bee566d40d5287110b0f0d7e42cbb8e567a4dafd551e0b502105a94378&ipo=images"
					></img>
				</div>
				...
				<img
					className="star"
					alt="Star"
					src="https://c.animaapp.com/sHJwGhwy/img/star-1.svg"
				/>
				<img
					className="star-2"
					alt="Star"
				...
				<img
					className="vector-2"
					alt="Vector"
					src="https://c.animaapp.com/sHJwGhwy/img/vector-3.svg"
				/>
				<img
					className="vector-3"
					alt="Vector"
				...
				<img
					className="image-3"
					alt="Image"
					src="https://c.animaapp.com/sHJwGhwy/img/image-2@2x.png"
				/>
			</div>
		</div>
	);
