    ...
    <div className="dashboard">
      {/* <div className="overlap-wrapper"> */}
          ...
          <div className="search">
            <div className="group">
              <div className="text-wrapper">Search Courses, Documents, Activities...</div>
              <img
            ...
            <div className="overlap-2">
              ...
              <div className="overlap-group-wrapper">
                <div className="overlap-group-3">
                  ...
                  <img className="image" alt="Image" src="https://c.animaapp.com/GvWiOB2X/img/image-296.png" />
                </div>
              </div>
            </div>
          </Button>
          <Button mt={'45px'} ml={'-20px'} variant={'none'} as={Link} href="/desktop" className="div-wrapper">
            <div className="overlap-3">
              ...
              />
              <div className="text-wrapper-5">Introduction to Financial Literacy</div>
            ...
            <div className="overlap-6">
              ...
              <div className="life-cont">
                <div className="overlap-7">
                  <div className="text-wrapper-54">Introduction to Financial Literacy</div>
          ...
          <div className="messages">
            <div className="overlap-13">
              ...
              <img className="line" alt="Line" src="https://c.animaapp.com/GvWiOB2X/img/line-1.svg" />
              <img className="line-2" alt="Line" src="https://c.animaapp.com/GvWiOB2X/img/line-1.svg" />
              <img className="line-3" alt="Line" src="https://c.animaapp.com/GvWiOB2X/img/line-1.svg" />
              <div className="josh">
